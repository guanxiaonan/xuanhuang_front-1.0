        ...
        on: {
            'click': () => {
                if (!currentRow.editting) {
                    ...
                    vm.putData(vm.edittingStore[index])
                    ...
                    console.log(vm.edittingStore[index])
                    console.log("0000")
                }
            }
        }
    ...
    return h('Poptip', {
        ...
        on: {
            'on-ok': () => {
                ...
                console.log(vm.edittingStore[index])
                console.log(index)
                console.log(vm.edittingStore[index].id)

              axios.delete(`/api/material/${vm.edittingStore[index].id}`,{
                headers: {
...
export default {
    ...
    methods: {
        ...
        putData(data) {
            ...
            axios.put('/api/material', material,{
                        headers: {
                                'Content-Type': 'application/json'
                        }
              })
